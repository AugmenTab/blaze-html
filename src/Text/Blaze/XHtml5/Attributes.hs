...
--
-- | Combinator for the @accent@ attribute.
--
-- Example:
--
-- > div ! accent "bar" $ "Hello."
--
-- Result:
--
-- > <div accent="bar">Hello.</div>
--
accent :: AttributeValue  -- ^ Attribute value.
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @accentunder@ attribute.
--
-- Example:
--
-- > div ! accentunder "bar" $ "Hello."
--
-- Result:
--
-- > <div accentunder="bar">Hello.</div>
--
accentunder :: AttributeValue  -- ^ Attribute value.
            -> Attribute       -- ^ Resulting attribute.
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @depth@ attribute.
--
-- Example:
--
-- > div ! depth "bar" $ "Hello."
...
-- Result:
--
-- > <div depth="bar">Hello.</div>
--
depth :: AttributeValue  -- ^ Attribute value.
      -> Attribute       -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! display "bar" $ "Hello."
--
-- Result:
--
-- > <div display="bar">Hello.</div>
--
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @encoding@ attribute.
--
-- Example:
--
-- > div ! encoding "bar" $ "Hello."
--
-- Result:
--
-- > <div encoding="bar">Hello.</div>
--
encoding :: AttributeValue  -- ^ Attribute value.
         -> Attribute       -- ^ Resulting attribute.
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @largeop@ attribute.
--
-- Example:
--
-- > div ! largeop "bar" $ "Hello."
--
-- Result:
--
-- > <div largeop="bar">Hello.</div>
--
largeop :: AttributeValue  -- ^ Attribute value.
        -> Attribute       -- ^ Resulting attribute.
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @linethickness@ attribute.
--
-- Example:
--
-- > div ! linethickness "bar" $ "Hello."
--
-- Result:
--
-- > <div linethickness="bar">Hello.</div>
--
linethickness :: AttributeValue  -- ^ Attribute value.
              -> Attribute       -- ^ Resulting attribute.
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @lspace@ attribute.
--
-- Example:
--
-- > div ! lspace "bar" $ "Hello."
--
-- Result:
--
-- > <div lspace="bar">Hello.</div>
--
lspace :: AttributeValue  -- ^ Attribute value.
       -> Attribute       -- ^ Resulting attribute.
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @maxsize@ attribute.
--
-- Example:
--
-- > div ! maxsize "bar" $ "Hello."
--
-- Result:
--
-- > <div maxsize="bar">Hello.</div>
--
maxsize :: AttributeValue  -- ^ Attribute value.
        -> Attribute       -- ^ Resulting attribute.
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @minsize@ attribute.
--
-- Example:
--
-- > div ! minsize "bar" $ "Hello."
--
-- Result:
--
-- > <div minsize="bar">Hello.</div>
--
minsize :: AttributeValue  -- ^ Attribute value.
        -> Attribute       -- ^ Resulting attribute.
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @moveablelimits@ attribute.
--
-- Example:
--
-- > div ! moveablelimits "bar" $ "Hello."
--
-- Result:
--
-- > <div moveablelimits="bar">Hello.</div>
--
moveablelimits :: AttributeValue  -- ^ Attribute value.
               -> Attribute       -- ^ Resulting attribute.
moveablelimits = attribute "moveablelimits" " moveablelimits=\""
{-# INLINE moveablelimits #-}
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @nonce@ attribute.
--
-- Example:
--
-- > div ! nonce "bar" $ "Hello."
...
-- Result:
--
-- > <div nonce="bar">Hello.</div>
--
nonce :: AttributeValue  -- ^ Attribute value.
      -> Attribute       -- ^ Resulting attribute.
nonce = attribute "nonce" " nonce=\""
{-# INLINE nonce #-}
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @rspace@ attribute.
--
-- Example:
--
-- > div ! rspace "bar" $ "Hello."
--
-- Result:
--
-- > <div rspace="bar">Hello.</div>
--
rspace :: AttributeValue  -- ^ Attribute value.
       -> Attribute       -- ^ Resulting attribute.
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @stretchy@ attribute.
--
-- Example:
--
-- > div ! stretchy "bar" $ "Hello."
--
-- Result:
--
-- > <div stretchy="bar">Hello.</div>
--
stretchy :: AttributeValue  -- ^ Attribute value.
         -> Attribute       -- ^ Resulting attribute.
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @symmetry@ attribute.
--
-- Example:
--
-- > div ! symmetry "bar" $ "Hello."
--
-- Result:
--
-- > <div symmetry="bar">Hello.</div>
--
symmetry :: AttributeValue  -- ^ Attribute value.
         -> Attribute       -- ^ Resulting attribute.
symmetry = attribute "symmetry" " symmetry=\""
{-# INLINE symmetry #-}
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @voffset@ attribute.
--
-- Example:
--
-- > div ! voffset "bar" $ "Hello."
--
-- Result:
--
-- > <div voffset="bar">Hello.</div>
--
voffset :: AttributeValue  -- ^ Attribute value.
        -> Attribute       -- ^ Resulting attribute.
