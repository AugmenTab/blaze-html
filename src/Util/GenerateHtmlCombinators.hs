...
html5 = HtmlVariant
    ...
    , parents =
        [ "a", "abbr", "address", "annotation", "article", "aside", "audio", "b"
        , "bdi", "bdo", "blockquote", "body", "button", "canvas", "caption"
        , "cite", "code", "colgroup", "command", "data", "datalist", "dd", "del"
        , "details", "dfn", "dialog", "div", "dl", "dt", "em", "fieldset"
        , "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5"
        , "h6", "head", "header", "hgroup", "html", "i", "iframe", "ins", "kbd"
        , "label", "legend", "li", "main", "map", "mark", "math", "menu"
        , "merror", "meter", "mfrac", "mi", "mmultiscripts", "mn", "mo", "mover"
        , "mphantom", "mroot", "mrow", "ms", "msqrt", "mstyle", "msub"
        , "msubsup", "msup", "mtable", "mtd", "mtext", "mtr", "munder"
        , "munderover", "nav", "noscript", "object", "ol", "optgroup", "option"
        , "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby"
        , "s", "samp", "search", "semantics", "script", "section", "select"
    ...
    , leafs =
        ...
        , "link", "menuitem", "meta", "mpadded", "mspace"
        , "param", "source", "track", "wbr"
        ]
    , attributes =
        [ "accept", "accept-charset", "accent", "accentunder", "accesskey"
        , "action", "alt", "async", "autocomplete", "autofocus", "autoplay"
        , "challenge", "charset", "checked", "cite", "class", "cols", "colspan"
        , "content", "contenteditable", "contextmenu", "controls", "coords"
        , "data", "datetime", "defer", "depth", "dir", "disabled", "display"
        , "draggable", "encoding", "enctype", "for", "form", "formaction"
        , "formenctype", "formmethod", "formnovalidate", "formtarget", "headers"
        , "height", "hidden", "high", "href", "hreflang", "http-equiv", "icon"
        , "id", "ismap", "item", "itemprop", "itemscope", "itemtype", "keytype"
        , "label", "lang", "largeop", "linethickness", "list", "loop", "low"
        , "lspace", "manifest", "max", "maxlength", "maxsize", "media", "method"
        , "min", "minsize", "moveablelimits", "multiple", "name", "nonce"
        ...
        , "required", "reversed", "role", "rows", "rowspan", "rspace", "sandbox"
        , "scope", "scoped", "seamless", "selected", "shape", "size", "sizes"
        , "span", "spellcheck", "src", "srcdoc", "start", "step", "stretchy"
        , "style", "subject", "summary", "symmetry", "tabindex", "target"
        , "title", "type", "usemap", "value", "voffset", "width", "wrap"
        , "xmlns"
        ]
    , selfClosing = False
    }
